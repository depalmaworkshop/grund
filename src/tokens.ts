 ...
 *
 * wip-1 (2025-12-27) - Initial version
 ...
 * ============================================================================
 *
 * This file (src/tokens.ts) is the source of truth for design tokens.
 *
 * GitHub: depalmaworkshop/grund
 * NPM (future): @depalmaworkshop/grund
 *
 * ============================================================================
 * TOKEN STRUCTURE
 * ============================================================================
 ...
 * ============================================================================
 *
 * - Research: Open Props, Carbon, Radix comparison
 * - Decisions: Lowercase breakpoints (Tailwind), full spacing scale, CMS-first evolution
 ...
 * ============================================================================
 *
 * - Complete token values (replace remaining TODO placeholders)
 * - Extract to a standalone NPM package
 * - Figma token sync
 ...
 * Spacing System
 *
 * Decision: Full Tailwind Standard Scale
 ...
 *
 * See: docs/foundations/spacing.md
 */
 ...
 *
 * See: docs/foundations/sizing.md
 */
export const sizing = {
  // ---------------------------------------------------------------------------
 ...
 *
 * See: docs/foundations/breakpoints.md
 */
 ...
 *
 * See: docs/foundations/radius.md
 */
export const radius = {
 ...
 *
 * See: docs/foundations/prominence.md
 */
 ...
 *
 * See: docs/foundations/motion.md
 */
export const motion = {
  // ---------------------------------------------------------------------------
  // DURATIONS
 ...
 *
 * See: docs/foundations/z-index.md
 */
export const zIndex = {
  // Standard layers
 ...
 *
 * See: docs/foundations/iconography.md
 */
...
// -----------------------------------------------------------------------------
// Toast Component
// See: docs/components/component-toast.md
// -----------------------------------------------------------------------------
export const toast = {
...
// -----------------------------------------------------------------------------
// Modal Component
// See: docs/components/component-modal.md
// -----------------------------------------------------------------------------
export const modal = {
  zIndex: {
...
// See: docs/components/component-button.md
// -----------------------------------------------------------------------------
export const button = {
  base: {
...
// See: docs/components/component-input.md
// -----------------------------------------------------------------------------
export const input = {
  base: {
...
// See: docs/components/component-select.md
// -----------------------------------------------------------------------------
export const select = {
 ...
 *
 * Usage:
 * import { color, typography, spacing } from '@depalmaworkshop/grund'
 *
